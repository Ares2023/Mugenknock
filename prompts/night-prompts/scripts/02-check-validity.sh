...
PYEOF
  ...
  while true; do
    ...
    "$CLAUDE_CMD" -p --model sonnet --tools WebFetch --allowed-tools WebFetch < "$PROMPT_FILE" > "$_STDOUT_F" 2> "$_STDERR_F"
    AI_EXIT=$?
