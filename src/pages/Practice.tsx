          ...
          <div style={{ marginBottom: 'var(--spacing-md)' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
              <button
                ...
                disabled={limit <= 5}
                style={{ width: 44, height: 44, borderRadius: '50%', border: '1px solid var(--color-text-sub)', background: 'transparent', cursor: limit <= 5 ? 'default' : 'pointer', fontSize: 20, display: 'flex', alignItems: 'center', justifyContent: 'center', color: limit <= 5 ? 'var(--color-text-light)' : 'var(--color-text-main)' }}
              >−</button>
              ...
              <button
                ...
                style={{ width: 44, height: 44, borderRadius: '50%', border: '1px solid var(--color-text-sub)', background: 'transparent', cursor: limit >= (examCfg?.totalQuestions ?? 65) ? 'default' : 'pointer', fontSize: 20, display: 'flex', alignItems: 'center', justifyContent: 'center', color: limit >= (examCfg?.totalQuestions ?? 65) ? 'var(--color-text-light)' : 'var(--color-text-main)' }}
              >+</button>
            </div>
          </div>
