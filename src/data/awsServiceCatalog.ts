...
export const CATALOG: Category[] = [
  ...
  },
  {
    ...
    services: [
      ...
      { name: 'AWS App Mesh',                         icon: '/icons/aws/AppMesh.png' },
  ...
  },
  {
    ...
    services: [
      ...
      { name: 'Amazon Fraud Detector',               icon: '/icons/aws/FraudDetector.png' },
  ...
  },
  {
    ...
    services: [
      ...
      { name: 'Amazon WorkDocs',                     icon: '/icons/aws/WorkDocs.png' },
      { name: 'Amazon WorkMail',                     icon: '/icons/aws/WorkMail.png' },
      { name: 'Amazon Connect Health' },
      { name: 'Amazon Connect Decisions' },
      { name: 'Amazon Pinpoint',                     icon: '/icons/aws/Pinpoint.png' },
      { name: 'AWS Wickr' },
      { name: 'AWS AppFabric' },
