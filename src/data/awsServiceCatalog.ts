...
export const CATALOG: Category[] = [
  {
    ...
    services: [
      ...
      { name: 'AWS Outposts',                         icon: '/icons/aws/Outposts.png' },
      { name: 'EC2 Image Builder',                   icon: '/icons/aws/EC2ImageBuilder.png' },
  ...
  },
  {
    ...
    services: [
      ...
      { name: 'AWS App Runner',                        icon: '/icons/aws/AppRunner.png' },
    ],
  },
  {
    category: 'ストレージ',
    services: [
      ...
      { name: 'Recycle Bin' },
      { name: 'AWS Elastic Disaster Recovery',    icon: '/icons/aws/ElasticDisasterRecovery.png' },
      { name: 'AWS Snowball',                          icon: '/icons/aws/Snowball.png' },
    ],
  },
  {
    category: 'データベース',
    services: [
      ...
      { name: 'Amazon Aurora',                         icon: '/icons/aws/Aurora.png' },
  ...
  },
  {
    category: '移行と転送',
    services: [
      { name: 'AWS Application Migration Service',     icon: '/icons/aws/AppMigrationService.png' },
      ...
      { name: 'AWS Transform',                        icon: '/icons/aws/Transform.png' },
      { name: 'AWS Mainframe Modernization' },
      { name: 'AWS Migration Hub',                     icon: '/icons/aws/MigrationHub.png' },
      { name: 'AWS Application Discovery Service',     icon: '/icons/aws/ApplicationDiscovery.png' },
  ...
  },
  {
    ...
    services: [
      ...
      { name: 'AWS Cloud Map',                        icon: '/icons/aws/CloudMap.png' },
      { name: 'RTB Fabric' },
      { name: 'Application Recovery Controller' },
      { name: 'AWS Cloud WAN',                         icon: '/icons/aws/CloudWAN.png' },
      { name: 'Amazon API Gateway (HTTP API / WebSocket API)', icon: '/icons/aws/APIGateway.png' },
      { name: 'Amazon Application Recovery Controller (ARC)', icon: '/icons/aws/ApplicationRecoveryController.png' },
    ],
  },
  {
    category: '開発者用ツール',
    services: [
      ...
      { name: 'CloudShell',                           icon: '/icons/aws/CloudShell.png' },
      { name: 'X-Ray',                                serviceIds: ['svc-x-ray-47'],                           icon: '/icons/aws/XRay.png' },
      { name: 'AWS FIS',                              icon: '/icons/aws/FaultInjectionService.png' },
      { name: 'AWS Fault Injection Service',           icon: '/icons/aws/FaultInjectionService.png' },
      { name: 'AWS Cloud Development Kit',             icon: '/icons/aws/CDK.png' },
      { name: 'Infrastructure Composer' },
      { name: 'AWS App Studio' },
      { name: 'AWS DevOps Agent',                    icon: '/icons/aws/DevOpsAgent.png' },
      { name: 'AWS AppConfig',                        icon: '/icons/aws/AppConfig.png' },
      { name: 'CodeArtifact',                         serviceIds: ['svc-codeartifact-79'],                    icon: '/icons/aws/CodeArtifact.png' },
      { name: 'Amazon Q Developer',                   icon: '/icons/aws/AmazonQ.png' },
      { name: 'Kiro' },
    ],
  },
  {
  ...
  },
  {
    category: 'ブロックチェーン',
    services: [
      { name: 'Amazon Managed Blockchain',           icon: '/icons/aws/ManagedBlockchain.png' },
    ],
  },
  {
    category: '衛星',
  ...
  },
  {
    ...
    services: [
      ...
      { name: 'Service Catalog',                      icon: '/icons/aws/ServiceCatalog.png' },
      ...
      { name: 'Amazon Q Developer in chat applications', icon: '/icons/aws/AmazonQ.png' },
      { name: 'Launch Wizard' },
      ...
      { name: 'Amazon Grafana',                       icon: '/icons/aws/ManagedGrafana.png' },
      { name: 'Amazon Prometheus',                    icon: '/icons/aws/ManagedServiceforPrometheus.png' },
      { name: 'Amazon Managed Service for Prometheus', icon: '/icons/aws/ManagedServiceforPrometheus.png' },
      { name: 'Amazon CloudWatch Application Insights', icon: '/icons/aws/CloudWatch.png' },
      { name: 'Amazon CloudWatch AI Ops investigations', icon: '/icons/aws/CloudWatch.png' },
      { name: 'Application Auto Scaling',              icon: '/icons/aws/AutoScaling.png' },
      { name: 'Amazon EC2 Auto Scaling',               icon: '/icons/aws/EC2AutoScaling.png' },
  ...
  },
  {
    ...
    services: [
      ...
      { name: 'AWS HealthLake',                       icon: '/icons/aws/HealthLake.png' },
      { name: 'Amazon Q Business',                    icon: '/icons/aws/AmazonQ.png' },
      ...
      { name: 'Amazon Bedrock AgentCore',             icon: '/icons/aws/BedrockAgentCore.png' },
      { name: 'Amazon Bedrock Data Automation',        icon: '/icons/aws/Bedrock.png' },
      { name: 'Amazon Q',                             icon: '/icons/aws/AmazonQ.png' },
  ...
  },
  {
    ...
    services: [
      ...
      { name: 'AWS Data Exchange',                    icon: '/icons/aws/DataExchange.png' },
      ...
      { name: 'Amazon SageMaker',                     icon: '/icons/aws/SageMakerAI.png' },
      { name: 'AWS Entity Resolution' },
      { name: 'AWS Glue',                             serviceIds: ['svc-glue-30'],                            icon: '/icons/aws/Glue.png' },
      { name: 'Amazon Data Firehose',                 icon: '/icons/aws/DataFirehose.png' },
  ...
  },
  {
    ...
    services: [
      { name: 'Resource Access Manager',              icon: '/icons/aws/ResourceAccessManager.png' },
      ...
      { name: 'Directory Service',                   icon: '/icons/aws/DirectoryService.png' },
      ...
      { name: 'Amazon Verified Permissions',        icon: '/icons/aws/VerifiedPermissions.png' },
      ...
      { name: 'AWS WAF',                               icon: '/icons/aws/WAF.png' },
      { name: 'AWS Shield',                            icon: '/icons/aws/Shield.png' },
      { name: 'Security Hub',                         serviceIds: ['svc-security-hub-75'],                    icon: '/icons/aws/SecurityHub.png' },
      { name: 'AWS Private Certificate Authority',    icon: '/icons/aws/PrivateCertificateAuthority.png' },
  ...
  },
  {
    category: 'モバイル',
    services: [
      { name: 'AWS Amplify',                          icon: '/icons/aws/Amplify.png' },
      { name: 'AWS AppSync',                          icon: '/icons/aws/AppSync.png' },
      { name: 'Device Farm' },
      { name: 'Amazon Location Service',             icon: '/icons/aws/LocationService.png' },
    ],
  },
  {
    category: 'アプリケーション統合',
    services: [
      ...
      { name: 'AWS B2B Data Interchange',              icon: '/icons/aws/B2BDataInterchange.png' },
  ...
  },
  {
    ...
    services: [
      ...
      { name: 'Amazon Connect',                        icon: '/icons/aws/Connect.png' },
      { name: 'Amazon Chime' },
  ...
  },
  {
    ...
    services: [
      { name: 'WorkSpaces',                           icon: '/icons/aws/WorkSpaces.png' },
  ...
  },
  {
    ...
    services: [
      ...
      { name: 'IoT Greengrass' },
      { name: 'IoT SiteWise' },
      { name: 'IoT Core',                             icon: '/icons/aws/IoTCore.png' },
      { name: 'IoT TwinMaker' },
    ],
  },
  {
    ...
    services: [
      ...
      { name: 'Amazon GameLift Streams',              icon: '/icons/aws/GameLiftStreams.png' },
    ],
  },
];
