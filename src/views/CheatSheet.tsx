  ...
  SAP: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'AWS Migration Hub', desc: 'AWS Migration Hubは、**Application** Migration Service・DMS等のAWS移行ツールの進捗を一元的に追跡・管理するダッシュボード。\nMigration Hub Refactor Spaces：マイクロサービスへのリファクタリング移行を支援するサービス', tags: ['移行追跡', 'ダッシュボード', '一元管理'] },
