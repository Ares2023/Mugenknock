  ...
  DEA: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Lake Formation', desc: 'データレイクの構築・管理・セキュリティを一元管理するサービス。\n列・行レベルのきめ細かいアクセス制御: Athena・GlueからS3のデータへのアクセスをカラム・行単位で制限できる\nBlueprint（ブループリント）: S3やRDBのデータを定期的にGlueワークフローでデータレイクに取り込むパイプラインを自動生成する機能', tags: ['列/行レベル', 'Blueprint', 'アクセス制御'], seeAlso: ['AWS Glue', 'Athena', 'Glue Data Catalog', 'Redshift', 'S3'] },
