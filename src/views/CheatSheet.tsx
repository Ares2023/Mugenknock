...
const CHEAT_DATA: CheatData = {
  CLF: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'AWS Trusted Advisor', desc: 'AWS Trusted Advisorは、コスト・性能・セキュリティ・耐障害性・サービス上限の5観点でAWS環境を診断し改善提案する**アドバイザーツール**。\n5つのカテゴリ：コスト最適化・パフォーマンス・セキュリティ・耐障害性・サービス上限\nBasicサポートでも一部のチェックは無料で使用できる。', tags: ['ベストプラクティス', 'コスト', 'セキュリティ'] },
      ],
    },
    {
      title: '管理・監視',
  ...
  SEC: [
    ...
    },
    {
      title: '脅威と攻撃',
      items: [
        { name: 'マルウェア', desc: 'マルウェアは、**悪意あるソフト**の総称。\n主な種類：\n- ウイルス / ワーム：自己増殖して感染を広げる\n- トロイの木馬：正規プログラムを装って侵入\n- ランサムウェア：データを暗号化して身代金を要求\n- スパイウェア / ボット：情報窃取・遠隔操作（C2から指令）\n対策：アンチウイルス・EDR（Endpoint Detection and Response：端末の不審な挙動を検知・対応する仕組み）・パターン更新・振る舞い検知・バックアップ', keyword: 'マルウェア ウイルス ワーム トロイの木馬 ランサムウェア ボット C2 EDR', tags: ['ランサムウェア', 'ワーム / トロイ', 'ボット / C2'] },
