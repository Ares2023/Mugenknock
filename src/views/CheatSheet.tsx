  ...
  CLF: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'AWS Elastic Beanstalk', desc: 'AWS Elastic Beanstalkは、アプリのコードをアップロードするだけでEC2・ELB・Auto Scalingを自動構築する**PaaS**サービス。\nインフラを意識せずにアプリを素早くデプロイしたい場合に適している。', tags: ['PaaS', 'デプロイ', '自動設定'] },
