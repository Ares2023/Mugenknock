...
const EXAM_CATCHCOPY: Record<string, string> = {
  CLF: 'さあ、クラウドの世界へ飛び込もう！🚀',
  AIF: 'AIと仲良くなれる、はじめの資格！🤖',
  SAA: 'AWS沼へようこそ！まずはここから！☁️',
  DVA: 'コードを書く人のための、開発者バッジ！💻',
  SOA: '障害なんか怖くない！運用職人への道！🔧',
  DEA: 'データの流れを操る、パイプラインの達人へ！📊',
  DOP: 'デプロイを秒で決める、DevOpsマスター！⚡',
  SAP: '設計の頂点！真のアーキテクトはここにいる！👑',
  MLA: 'モデルを育てて、本番に乗せる。MLの現場力！🧠',
  GAI: '生成AIを使いこなす、次世代エンジニアへ！✨',
  ANS: 'パケットの行き先、全部わかる！ネットワーク番長！🌐',
  SCS: '守って、検知して、即対応！セキュリティのプロへ！🛡️',
};
