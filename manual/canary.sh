...
#
# 使い方:
#   ./scripts/canary.sh                  → 検証環境 (mugenknock.pages.dev)
#   ./scripts/canary.sh prod             → 本番環境 (mugenknock.com)
#   PLAYWRIGHT_BASE_URL=https://xxx.pages.dev ./scripts/canary.sh
#
...
WARNINGS=$(grep -c "⚠️" "$LOG_FILE" 2>/dev/null || echo 0)
